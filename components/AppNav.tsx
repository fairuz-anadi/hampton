    ...
    <Sidebar>
      <SidebarBody className="justify-between gap-8">
          ...
          <div className="mt-9 flex flex-col gap-7">
            {groups.map((group) => (
              <div key={group.title} className="flex flex-col gap-1">
                <WhenExpanded className="px-4 pb-2 font-mono text-[22px] uppercase tracking-[0.14em] text-faint whitespace-nowrap">
                  {group.title}
                </WhenExpanded>
        ...
        <div className="flex flex-col gap-4">
          ...
          <WhenExpanded className="px-4 font-mono text-[22px] leading-relaxed text-faint whitespace-nowrap">
            CSE 2211 Algorithms
            <br />
            Mid-term · Q4(b)
            <br />
