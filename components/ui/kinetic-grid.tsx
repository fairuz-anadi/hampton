...
> = {
  light: {
    bg: "#faf9f7",
    lineBase: { r: 17, g: 17, b: 17, a: 0.07 },
    lineActive: { r: 17, g: 17, b: 17, a: 0.55 },
    nodeBase: { r: 17, g: 17, b: 17, a: 0.12 },
    nodeActive: { r: 17, g: 17, b: 17, a: 0.9 },
    dot: "rgba(17,17,17,0.06)",
    glow: "17,17,17",
    ripple: "17,17,17",
  },
  default: {
...
export default function KineticGrid({
  ...
  children?: ReactNode;
  className?: string;
  globalColor?: "light" | "default" | "monochrome";
}) {
  ...
  const draw = useCallback(
    (now: number) => {
      ...
      const theme = THEMES[globalColor] ?? THEMES.light;
  ...
  useEffect(() => {
    ...
    // Respect people who have asked for less motion: paint one static frame.
